...
// Inscription et vérification email uniquement. Le wallet reste une capacité
// financière facultative : il n'est jamais provisionné pendant l'onboarding
// personnel (ACC-01, PER-11).
