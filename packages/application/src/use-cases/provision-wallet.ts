...
// Phase E — appele depuis SignUpUseCase. Idempotent : un utilisateur n'a
// jamais plus d'un wallet ; un second appel renvoie celui deja provisionne
// plutot que d'en generer un autre.
